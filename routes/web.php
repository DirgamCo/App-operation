...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/reports/custom-report', [ReportController::class, 'getCustomReport']);
...
Route::middleware(['auth','AdminSidebarMenu', 'language', 'timezone'])->resource('cities', CityController::class)->except('show')->names([
...
Route::middleware(['auth','AdminSidebarMenu', 'language', 'timezone'])->resource('locations', LocationController::class)->except('show')->names([
