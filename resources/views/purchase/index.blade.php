...
@section('content')
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('purchase_list_filter_city_id', __('City') . ':') !!} {{-- Assuming 'city' is a translatable string --}}
                    {!! Form::select('purchase_list_filter_city_id', $cities, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'placeholder' => __('lang_v1.all'),
                    ]) !!}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('purchase_list_filter_gen_location_id', __('Location Inside City') . ':') !!} {{-- Choose an appropriate label --}}
                    {!! Form::select('purchase_list_filter_gen_location_id', $locations, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'placeholder' => __('lang_v1.all'),
                    ]) !!}
