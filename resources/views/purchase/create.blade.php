...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			...
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif d-none">
				<div class="form-group">
			...
			<div class="col-sm-3 @if(!$currency_details->purchase_in_diff_currency) hide @endif d-none">
				<div class="form-group">
	...
	@endcomponent
	@component('components.widget', ['class' => 'box-primary d-none', 'title' => __('purchase.add_payment')])
