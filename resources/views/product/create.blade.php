    ...
    <section class="content">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-4 d-none @if (!session('business.enable_sub_units')) hide @endif">
                    <div class="form-group">
                ...
                <div class="col-sm-6 d-none @if (!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
                    <div class="form-group">
                ...
                @php
                    $selected_locations = $business_locations->keys()->toArray();
                @endphp
                ...
                <div class="col-sm-4 d-none">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'product_locations[]',
                            $business_locations,
                            $selected_locations, // ✅ All options selected
        ...
        @component('components.widget', ['class' => 'box-primary d-none'])
            <div class="row">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="d-none col-sm-4 @if (!session('business.enable_price_tax')) hide @endif">
                    <div class="form-group">
                ...
                <div class="col-sm-4 d-none @if (!session('business.enable_price_tax')) hide @endif">
                    <div class="form-group">
                        {!! Form::label('tax_type', __('product.selling_price_tax_type') . ':*') !!}
                        {!! Form::select(
                            'tax_type',
                            ['inclusive' => __('product.inclusive'), 'exclusive' => __('product.exclusive')],
                            !empty($duplicate_product->tax_type) ? $duplicate_product->tax_type : 'inclusive',
                            ['class' => 'form-control select2', 'required'],
                        ) !!}
                    </div>
                </div>
