...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', 'form#edit_product_location_form', function(e) {
            ...
            $(document).ready(function () {
                $('#city_id, #loc_id').on('select', function () {
                    // Reload Sell Payment Report if initialized
                    if (typeof sell_payment_report !== 'undefined') {
                        sell_payment_report.ajax.reload();
                    }

                    // Reload Stock Report Table if initialized
                    if (typeof stock_report_table !== 'undefined' && $.fn.DataTable.isDataTable('#stock_report_table')) {
                        stock_report_table.ajax.reload();
                    }
                });
            });
