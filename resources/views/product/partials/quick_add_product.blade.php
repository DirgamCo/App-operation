  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif d-none">
          <div class="form-group">
        ...
        <div class="clearfix"></div>
        <div class="col-sm-4 d-none" id="alert_quantity_div">
          <div class="form-group">
