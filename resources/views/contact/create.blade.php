  ...
  @endphp
    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-md-4 mt-15 d-none">
            ...
            <div class="col-md-4 customer_fields d-none">
                <div class="form-group">
            ...
            <div class="col-md-4 business d-none">
                <div class="form-group">
            ...
            <div class="col-md-3 individual d-none">
                <div class="form-group">
            ...
            <div class="col-md-4 lead_additional_div d-none">
              <div class="form-group">
            ...
            <div class="col-md-6 lead_additional_div d-none">
                  <div class="form-group">
