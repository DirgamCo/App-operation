...
$menu->url(route('admin.cities.index'), __('Cities'), [
    'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.8 482.8" width="16" height="16" fill="currentColor"><path d="M482.8 482.8H0V0h121.7v74.8H77.2v63.2h44.5v46.6H77.2v63.2h44.5v46.6H77.2v63.2h44.5v46.6H77.2v63.2h44.5v15.5h37.1V182.1h59.2V81.3h59.3v401.5h37.1V296.9h44.5v-63.2h-44.5v-46.6h44.5v-63.2h-44.5V74.8h44.5V0H482.8z"/></svg>',
    'active' => request()->segment(1) == 'cities'
])->order(1000);

            if (auth()->user()->can('locations')) {
                $menu->url(route('admin.locations.index'), __('Areas'), ['icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M4 2L1 6v16h22V6l-3-4H4zm16.35 2l1.15 1.53V8H2.5V5.53L3.65 4h16.7zM21.5 20h-19v-10h19v10zM5 12h3v6H5v-6zm5 0h3v6h-3v-6zm5 0h3v6h-3v-6z"/></svg>', 'active' => request()->segment(1) == 'Areas'])->order(1001);
            }
        });
