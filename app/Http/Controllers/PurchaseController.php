    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            if(request()->filled('city_id')){
                $purchases->where('city_id',request()->city_id);
            }

            if(request()->filled('gen_location_id')){
                $purchases->where('loc.id',request()->gen_location_id);
            }
        ...
        return view('purchase.index', compact('cities', 'locations'))
