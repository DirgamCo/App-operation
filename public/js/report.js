$(document).ready(function () {
    ...
    $(
        '#loc_id,#city_id,#stock_report_filter_form #location_id, #stock_report_filter_form #category_id, #stock_report_filter_form #sub_category_id, #stock_report_filter_form #brand, #stock_report_filter_form #unit,#stock_report_filter_form #view_stock_filter'
    ).change(function () {
    ...
    //------------custom report --------------------------
    $('#custom_report_location_filter').change(function () {
        updateCustomReport();
    });
    ...
    $(
        '#loc_id,#city_id,#psr_customer_group_id, #psr_filter_category_id, #psr_filter_brand_id, #product_sell_report_form #variation_id, #product_sell_report_form #location_id, #product_sell_report_form #customer_id'
    ).change(function () {
        product_sell_report.ajax.reload();
        product_sell_grouped_report.ajax.reload();
        product_sell_report_with_purchase_table.ajax.reload();
    ...
    $(
        '#purchase_payment_report_form #location_id, #purchase_payment_report_form #supplier_id , #city_id , #loc_id'
    ).change(function () {
        purchase_payment_report.ajax.reload();
    });
    ...
    $('#city_id, #loc_id, #sell_payment_report_form select').change(function () {
        sell_payment_report.ajax.reload();
    });

    //custom report table ------------------------------------------------------------
    custom_report = $('table#custom_report_table').DataTable({
        processing: true,
        serverSide: true,
        pageLength: 10,
        fixedHeader: false,
        ...
        ajax: {
            ...
            data: function (d) {
                var start = $('#custom_report_date_filter')
                    .data('daterangepicker')
                    .startDate.format('YYYY-MM-DD');
                var end = $('#custom_report_date_filter')
                    .data('daterangepicker')
                    .endDate.format('YYYY-MM-DD');
    ...
    $(document).on(
        'change',
        '#loc_id,#city_id,#ir_supplier_id, #ir_customer_id, #ir_location_id',
        function () {
            items_report_table.ajax.reload();
        }
    );
